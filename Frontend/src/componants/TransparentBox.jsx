      ...
      <div className={`fixed inset-0 flex items-center justify-center z-[101] p-2 transition-all duration-700 ${
        ...
        <div className="relative w-full max-w-4xl mx-2 overflow-hidden transform transition-all duration-500 hover:scale-105 rounded-3xl
          ...
          <div className="relative h-full bg-gradient-to-br from-gray-900 via-black to-gray-900 rounded-3xl border border-gray-700/50 overflow-hidden flex flex-col">
            ...
            <button
              onClick={handleClose}
              className="absolute top-2 right-2 sm:top-4 sm:right-4 md:top-6 md:right-6 z-20 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-gray-800/80 hover:bg-red-500/80 rounded-full flex items-center justify-center transition-all duration-300 backdrop-blur-sm border border-gray-600 hover:border-red-400 group hover:rotate-90"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-gray-300 group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
              </svg>
            </button>

            {/* Header Section - Dark Theme */}
            <div className="relative px-4 sm:px-6 md:px-8 py-4 sm:py-6 overflow-hidden flex-shrink-0">
              {/* Animated Background */}
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                  <div className="flex items-center gap-2 bg-green-500/20 px-3 sm:px-4 py-1 sm:py-2 rounded-full border border-green-500/30">
                    <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                    <span className="text-xs sm:text-sm font-medium text-green-300 animate-pulse">Live Enrollment</span>
                  </div>
                  <div className="px-3 sm:px-4 py-1 sm:py-2 bg-orange-500/20 rounded-full border border-orange-500/30">
                    <span className="text-xs sm:text-sm text-orange-300 font-mono animate-pulse">12 SEATS LEFT</span>
                  </div>
                </div>
                
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-1 sm:mb-2 bg-gradient-to-r from-white to-blue-200 bg-clip-text text-transparent animate-pulse">
                  CodeEternity
                </h2>
                <p className="text-gray-300 text-base sm:text-lg md:text-xl">Transform your coding journey into infinity</p>
              </div>
            </div>

            {/* Content Section - Light Theme */}
            <div className="bg-gradient-to-br from-white to-gray-50 p-3 sm:p-4 md:p-6 space-y-3 sm:space-y-4 flex-1 min-h-0 overflow-y-auto">
              
              {/* Benefits Grid */}
              <div>
                <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mb-3 sm:mb-4 text-center">Unlock Your Potential</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3">
                  {[
                    ...
                    <div key={index} className={`group p-3 sm:p-4 rounded-2xl bg-gradient-to-r ${item.color} text-white transform transition-all duration-300 hover:scale-105 hover:rotate-1 animate-pulse`} style={{animationDelay: `${index * 200}ms`}}>
                      <div className="flex items-center gap-2 sm:gap-3">
                        <div className="text-xl sm:text-2xl animate-bounce" style={{animationDelay: `${index * 100}ms`}}>{item.icon}</div>
                        <div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4">
                {/* Animated Stats */}
                <div className="bg-gradient-to-r from-gray-900 to-black rounded-2xl sm:rounded-3xl p-3 sm:p-5 text-white relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-600/20 to-blue-800/20 animate-pulse"></div>
                  <div className="relative z-10">
                    <h4 className="text-center text-base sm:text-lg font-semibold mb-2 sm:mb-3 text-blue-200">Success Stories</h4>
                    <div className="grid grid-cols-3 gap-2 sm:gap-4 text-center">
                      {[
                        ...
                        <div key={index} className="transform transition-all duration-300 hover:scale-110">
                          <div className={`text-lg sm:text-2xl font-bold ${stat.color} animate-pulse`} style={{animationDelay: `${index * 300}ms`}}>
                            {stat.num}
                          </div>
                ...
                {/* Urgency Banner */}
                <div className="relative bg-gradient-to-r from-gray-800 to-black rounded-2xl p-3 sm:p-5 text-white overflow-hidden flex items-center">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent animate-pulse"></div>
                  <div className="relative z-10 flex items-center gap-2 sm:gap-3">
                    <div className="w-6 h-6 sm:w-8 sm:h-8 bg-white/20 rounded-full flex items-center justify-center animate-spin flex-shrink-0">
                      <svg className="w-3 h-3 sm:w-4 sm:h-4" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clipRule="evenodd" />
                      </svg>
                    </div>
                    <div>
                      <p className="font-bold text-xs sm:text-sm">⚡ Flash Enrollment Ending Soon!</p>
              ...
              <div className="space-y-2 sm:space-y-3">
                <a
                  ...
                  className="group relative w-full bg-gradient-to-r from-purple-700 to-purple-800 text-white py-3 sm:py-4 px-4 sm:px-8 rounded-xl sm:rounded-2xl font-bold text-base sm:text-xl text-center inline-flex items-center justify-center gap-2 sm:gap-3 transition-all duration-500 transform hover:scale-105 hover:rotate-1 shadow-2xl hover:shadow-blue-500/50 overflow-hidden"
                >
                ...
                <div className="text-center">
                  <button 
                    onClick={handleClose}
                    className="text-xs sm:text-sm text-gray-500 hover:text-gray-700 transition-colors duration-300 underline"
                  >
                    I'll think about it
                  </button>
                </div>
              ...
              {/* Trust Indicators */}
              <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4 pt-2 sm:pt-3 border-t border-gray-200">
                <div className="flex items-center gap-1 sm:gap-2">
                  <div className="flex text-yellow-500">
                    {[...Array(5)].map((_, i) => (
                      <svg key={i} className="w-3 h-3 sm:w-4 sm:h-4 animate-pulse" style={{animationDelay: `${i * 100}ms`}} fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="text-xs sm:text-sm text-gray-600 font-medium">💯 Verified Reviews</div>
                <div className="w-px h-3 sm:h-4 bg-gray-300"></div>
                <div className="text-xs sm:text-sm text-gray-600">🔒 Secure & Trusted</div>
              </div>
            </div>
          </div>
        </div>
